...
typedef std::conditional<dd_choice,BddSet,SddSet>::type vset;
...
inline SddManager* Sdd::Manager = sdd_manager_create(2*get_variables(),0);
inline SddManager* SddSatEnum::Manager1 = Sdd::Manager;
